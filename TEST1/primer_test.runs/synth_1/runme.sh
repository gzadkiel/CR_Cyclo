...
HD_PWD='C:/Users/gm/Vivado Projects/primer_test/primer_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_stage_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_stage_control.tcl
